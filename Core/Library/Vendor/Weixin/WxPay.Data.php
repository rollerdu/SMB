...
class WxPayResults extends WxPayDataBase
{
	 ...
	 * $array();
	**/
	public function ToResultWeixin($array)
	{
    	$xml = "<xml>";
	 ...
	 * return array()
	 */
	public  function returenAppFromArray($arr){
		$obj = new self();
		$t['partnerid'] = WxPayConfig::MCHID; //商户号
		$t['appid']     = WxPayConfig::APPID;//绑定支付的APPID
		$t['noncestr']  = $arr['nonce_str'];
		$t['package']   = 'Sign=WXPay';
		$t['timestamp'] = time();
		$t['prepayid']  = $arr['prepay_id'];
		$obj->FromArray($t);
		$t['sign'] = $obj->MakeSign();
		return $t;
	}
